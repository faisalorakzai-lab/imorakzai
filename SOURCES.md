...
### 1. Book Cover / Title Page Background
- **File**: `book/images/cover.png`
- **Source**: Provided by the author (Faisal Orakzai).
- **License**: Proprietary / Author-owned.
- **Description**: Cinematic composition featuring traditional Pashtun heritage and modern technological elements.
...
## Page 32: Origins of the Orakzai
- **Research Sources**: Detailed citations are available in `book/sources/page-032-origins-of-the-orakzai.md`.
...
## Page 41: Orakzai Territory
- **Research Sources**: Detailed citations are available in `book/sources/page-041-orakzai-territory.md`.
- **Visual Elements**: 30+ custom SVG logic diagrams covering the historical homeland map, geography-to-identity models, elevation profiles, and route networks.
- **Content**: Original documentary synthesis by Faisal Orakzai, supported by Lucas White King, official district records, and historical gazetteers.
- **License**: Content is proprietary to the author; visual design is project-specific.

## Page 42: Geography of Orakzai
- **Research Sources**: Detailed citations are available in `book/sources/page-042-geography-of-orakzai.md`.
...
## Page 48: Livestock & Rural Economy
- **Research Sources**: Detailed citations are available in `book/sources/page-048-livestock-rural-economy.md`.
...
## Page 63: Pashto Proverbs
- **Research Sources**: Detailed citations are available in `book/sources/page-063-pashto-proverbs.md`.
...
## Page 75: Tribal Resistance
- **Research Sources**: Detailed citations are available in `book/sources/page-075-tribal-resistance.md`.
...
## Page 88: Infrastructure & Connectivity
- **Research Sources**: Detailed citations are available in `book/sources/page-088-infrastructure-and-connectivity.md`.
...
The Page 97 HTML source contains a responsive, JavaScript-free SVG logic atlas with 70 graphics in total, including the hero, destination frameworks, Gulf/Europe/North America/Australia sections, family and cultural continuity models, evidence matrices, research gaps, and final statement. Page 98 is documented below.

## Page 98: Global Orakzai Communities
- **Research Sources**: Detailed citations are available in `book/sources/page-098-global-orakzai-communities.md`; methodological notes are in `book/sources/page-098-research-notes.md`.
- **Visual Elements**: 78 original responsive SVG graphics: one premium hero, one evidence-status world map, and 75 accessible three-stage logic cards. The atlas covers community definition, Orakzai/Pashtun/Pakistani distinctions, evidence levels, generations, Gulf and Western destinations, informal and digital networks, religious and cultural spaces, language, food, music, poetry, Attan, elders, women, youth, students, professionals, business, charity, archives, AI preservation, remittances, homeland connection, cultural change, risks, opportunities, matrices, oral history, identity, and the final statement.
- **Content**: Research-based analysis of global Orakzai community formation, with strict separation between Orakzai-specific evidence, broader Pashtun context, Pakistani-wide migration data, individual leadership records, family testimony, informal networks, and research gaps. The page uses Robert Nichols for the historical Pashtun migration framework; UN DESA and Pakistan BEOE data are used only as national/international migration context; public Australia records document individual Orakzai participation in a wider Pashtun community space.
- **Evidence Boundary**: No fabricated global Orakzai population, country or city distribution, membership figure, founding date, organization, event, or surname-based identity inference is presented. “No reliable public Orakzai count located” means that a defensible public tribe-specific count was not found in the reviewed evidence; it does not mean no Orakzais live in a destination.
- **Technical**: The page is JavaScript-free, EPUB 3 compatible, responsive, printable, and includes SVG `<title>` and `<desc>` accessibility metadata for every atlas card.
...
## Page 98 — Global Orakzai Communities: Verified Source Ledger

Page 98 treats “global community” as a research question rather than a pre-counted institution. Nichols provides the Pashtun-wide historical mobility context. UN DESA’s International Migrant Stock 2024 and Pakistan’s BEOE reports demonstrate what national and international migration datasets can measure; they do not provide a global tribal census. Dijkzeul and Fauser, together with Orozco and Rouse, support the conceptual distinction between informal family networks, voluntary associations, hometown organizations, and transnational activity. Public Australian records are used only to document an individual Orakzai participant in a broader Pashtun community setting.

The page’s central claim is therefore bounded: Orakzai people may participate in family networks, digital groups, cultural spaces, professional circles, Pakistani institutions, and broader Pashtun organizations across different destinations, but the global structure, size, and distribution of Orakzai communities remain under-documented as a distinct research subject. Future research should document how people actually connect, with consent and destination-specific evidence.

## Page 99: Identity in the Diaspora

Page 99 examines diaspora identity as a personal, contextual, multi-layered, intergenerational, and dynamic process. It separates Orakzai identity from broader Pashtun identity, Pakistani national identity, religious identity, host-country identity, and professional identity. The page does not treat language, religion, nationality, birthplace, surname, or residence as sufficient to determine an individual’s identity.

- **Research Sources**: Detailed citations are available in `book/sources/page-099-identity-in-the-diaspora.md`; methodological notes are in `book/sources/page-099-research-notes.md`.
- **Visual Elements**: 73 original responsive SVG graphics: one premium identity hero, one identity-flow diagram, one concentric multi-layer diagram, and 70+ accessible logic graphics covering identity, homeland, language, religion, generations, digital identity, authenticity, evidence, research gaps, and the final statement.
- **Content**: Evidence-led analysis using Robert Nichols for Pashtun-wide migration history; Khalid, Khan, and Joseph for migrant-Pashto family language policy in Lahore; Rafiq and Dunnett for three-generation British Pakistani identity negotiation; Moya for comparative immigrant associations; and narrowly bounded public or repository records for individual examples and research leads.
- **Evidence Boundary**: Comparative Pashtun, Pakistani, migrant-Pashto, British Pakistani, and general diaspora research is clearly labelled and never converted into Orakzai-specific identity statistics or universal experiences. The page does not invent identity surveys, language-retention percentages, marriage rates, generation-specific population estimates, community sizes, or personal stories.
- **Technical**: The page is JavaScript-free, EPUB 3 compatible, responsive, printable, and includes SVG `<title>` and `<desc>` accessibility metadata for every atlas graphic. Page 100 was not created.
- **License**: Content is proprietary to the author; visual design is project-specific; graphics are original and created for this book.

## Page 100: The Modern Orakzai

Page 100 is the first major 100-page milestone of *I’M ORAKZAI*. It brings the history, culture, administration, migration, and diaspora discussions into the present without treating modernity as Westernization or tradition as backwardness. The page’s central formula is roots → change → adaptation → opportunity → responsibility → future.

The page uses the official record of Pakistan’s 2018 constitutional merger to establish administrative change, not cultural disappearance. It uses the UNDP/Japan-supported 2025 digital-skills initiative as a concrete contemporary development example: 600 young people from Orakzai and Kurram participated, and 52% of that programme cohort were women. It uses the KP Youth Affairs career-counselling event record to document contemporary themes of education, legal employment, digital skills, peacebuilding, and community development. Neither event is converted into a district-wide statistic or universal youth experience.

- **Research Sources**: Detailed citations and claim boundaries are available in `book/sources/page-100-the-modern-orakzai.md`; research notes and URLs are in `book/sources/page-100-research-notes.md`.
- **Visual Elements**: 74 original responsive SVG graphics: one premium multi-generational hero, one modernity formula, one 100-page milestone timeline, and 70 numbered logic-atlas cards. The atlas covers administration, education, digital work, entrepreneurship, agriculture, markets, women, youth, family, elders, language, AI, cities, diaspora, citizenship, infrastructure, environment, health, evidence boundaries, research gaps, oral history, and the future.
- **Content**: Evidence-led analysis connects Pages 28, 47, 49, 50, 65–70, 73, 84–89, 92–99, and the present Page 100. It distinguishes documented facts, programme-specific evidence, analytical frameworks, and emerging possibilities.
- **Evidence Boundary**: No employment statistics, internet penetration rate, income level, startup count, business count, technology-adoption rate, women’s employment rate, youth-unemployment rate, or diaspora count is invented. Remote work, digital entrepreneurship, AI-assisted education, tourism, knowledge economy, digital archives, and technology-driven agriculture are presented as possibilities, not current district-wide realities.
- **Milestone**: Page 100 records the sequence Page 1 → ancestry; Page 25 → language and culture; Page 50 → life and community; Page 75 → history and frontier; Page 100 → The Modern Orakzai. The milestone explicitly says “100 pages. One people. Many generations. An unfinished story.” It does not imply the 200-page book has ended.
- **Technical**: The page is JavaScript-free, EPUB 3 compatible, responsive, printable, and includes SVG `<title>` and `<desc>` accessibility metadata for every numbered atlas graphic. Page 101 was not created.
- **License**: Content is proprietary to the author; visual design is project-specific; graphics are original and created for this book.

## Page 101: From Tribal Society to Modern Society

Page 101 examines the long social transition from traditional community structures toward modern institutional, educational, urban, technological, and economically connected society. Its central concept is **change without erasure**. The page does not equate tribal society with backwardness or modern society with superiority; it treats both as complex social formations containing cooperation, conflict, hierarchy, opportunity, inequality, belonging, and pressure.

The page uses Akbar S. Ahmed’s work as foundational anthropological context for Pashtun social organization and Orakzai fieldwork. The official record of Pakistan’s Twenty-fifth Constitutional Amendment establishes the 2018 legal-administrative merger of former FATA into Khyber Pakhtunkhwa. UNDP/Japan programmes from 2024 and 2025 are used as bounded contemporary development evidence: reported vocational training for 700 youth including 375 women, and digital-skills training for 600 youth with 52% women participants. The 2022 stabilization and economic-recovery programme is described as a planned intervention, not completed district-wide transformation.

- **Research Sources**: Detailed citations and claim boundaries are available in `book/sources/page-101-from-tribal-society-to-modern-society.md`; research notes and URLs are in `book/sources/page-101-research-notes.md`.
- **Visual Elements**: 67 original responsive SVG elements: one premium transition hero, one subtle page-background SVG, and 65 numbered accessible logic-atlas cards. The atlas covers tribal and modern society definitions, kinship, elders, jirga, hujra, custom and law, FCR-to-constitutional governance, administration, family, marriage, birth, mourning, hospitality, education, women, youth, digital and vocational transformation, economy, markets, migration, urbanization, diaspora, language, religion, values, rights, citizenship, intergenerational change, research gaps, and the final statement.
- **Content**: Evidence-led analysis connects Pages 24, 28, 47, 49, 50, 53, 56–59, 63–70, 73–80, 83–91, and 92–100. It distinguishes documented administrative and development evidence from interpretive frameworks about continuity, adaptation, and social change.
- **Evidence Boundary**: No social statistic, employment figure, internet penetration rate, literacy rate, women’s employment rate, migration number, household statistic, urbanization percentage, or district-wide programme outcome is invented. Jirga, hujra, customary law, language, religion, family continuity, and cultural adaptation are described with scope cautions and explicit research gaps.
- **Technical**: The page is JavaScript-free, EPUB 3 compatible, responsive, printable, and includes SVG `<title>` and `<desc>` accessibility metadata for every numbered atlas graphic. Page 102 was not created.
- **License**: Content is proprietary to the author; visual design is project-specific; graphics are original and created for this book.

## Page 102: Tradition vs Modernity

Page 102 examines the relationship between tradition and modernity in Orakzai life. It rejects the false choice of tradition versus modernity and develops the model **tradition + adaptation + modernity + identity**. Its central question is how a people can enter the future without losing the knowledge, language, relationships, and memories that connect them to the past.

The page defines tradition as transmitted practices, knowledge, beliefs, expressions, and social patterns, while insisting on classification: Orakzai-specific, Pashtun-wide, regional, Islamic, family-specific, or oral-history evidence. It defines modernity through institutions, education, citizenship, technology, urbanization, professional life, healthcare, markets, and digital connectivity without equating modernity with Westernization. The Twenty-fifth Constitutional Amendment is used to document institutional change, not the end of culture. UNDP/Japan programmes from 2024 and 2025 remain bounded programme evidence, not district-wide cultural transformation.

- **Research Sources**: Detailed citations and claim boundaries are available in `book/sources/page-102-tradition-vs-modernity.md`; research notes and URLs are in `book/sources/page-102-research-notes.md`.
- **Visual Elements**: 71 original responsive SVG elements: one premium balanced tradition-modernity hero, one subtle page-background SVG, and 69 numbered accessible logic-atlas cards. Together the hero and cards provide 70 substantive graphics covering the false choice, tradition and modernity definitions, cultural classification, preservation, adaptation, religion, family, elders, youth, women, language, digital culture, AI, education, work, markets, migration, urbanization, diaspora, customary institutions, law, rights, memory, intergenerational transmission, evidence, research gaps, and the final statement.
- **Content**: Evidence-led analysis connects Pages 24, 28, 50, 53, 56–70, 73–86, 89–101. It distinguishes documented facts from interpretive frameworks and describes contemporary events as contemporary rather than inventing ancient origins.
...
## Page 137: Real Estate Tokenization

Page 137 examines the transformation of property rights into programmable digital infrastructure. It analyzes the property trust stack, focusing on the integration of legal foundations, property verification, and smart-contract distributions. The page highlights the global real estate tokenization market's valuation at $4.81 billion in 2026 and explores Pakistan's PropTech landscape, including blockchain-enabled land records and fractional ownership initiatives.

The content is grounded in 2026 reports from Precedence Research, PIDE, and industry milestones from the PropTech Convention Pakistan. It discusses the potential for tokenization to improve market efficiency and inclusion, while addressing the "Title Gap" and the necessity of legal recognition by government registries. A personal case study of Faisal Orakzai illustrates the generational shift toward approaching real estate as a system where software and physical assets intersect.

- **Research Sources**: Detailed bibliographic records and a real estate tokenization evidence matrix are available in `book/sources/page-137-real-estate-tokenization.md`; research notes and methodological findings are in `book/sources/page-137-research-notes.md`.
- **Visual Elements**: 116 original responsive SVG elements: one premium Real Estate Hero and 115 numbered accessible logic-atlas cards. The atlas covers fractionalization models, rental income distribution loops, property trust stacks, and the transition from paper-based registries to shared digital networks.
- **Content**: Evidence-led narrative connects Pages 103-110, and 111-136. It frames real estate tokenization as a tool for national digital transformation and inclusive property markets.
